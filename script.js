...
const translations = {
  en: {
    nav_home: "Home", nav_checker: "Symptom Guidance", nav_findcare: "Find Care", nav_records: "My Records", nav_maternal: "Maternal & Child", nav_adult: "Adult Health",
    ...
    feat_eyebrow: "What HealthBridge does", feat_head: "Everything you need, in one place", feat_sub: "Ten tools built around how care actually happens in your community. Tap any to explore.",
    ...
    findcare_all_states: "All states", findcare_all_lgas: "All LGAs", findcare_no_results: "No facilities found for that area yet.", findcare_directions: "Get Directions",
    ...
    adult_eyebrow: "Guidance for every stage of adult life", adult_head: "Adult Health",
    adult_sub: "General guidance on the health topics that matter most for adults — not a diagnosis, a starting point.",
    adult1_title: "Chronic Condition Awareness", adult1_sub: "Know the warning signs and the value of regular checks for common long-term conditions.",
    adult1_li1: "High blood pressure: often has no symptoms — get checked regularly",
    adult1_li2: "Diabetes: watch for excess thirst, frequent urination, fatigue",
    adult1_li3: "Routine screening matters even when you feel well",
    adult2_title: "Mental Health & Wellbeing", adult2_sub: "Mental health is health — it deserves the same attention as any physical concern.",
    adult2_li1: "Persistent sadness, worry, or loss of interest are worth discussing with someone",
    adult2_li2: "Sleep, stress, and social connection all affect mental wellbeing",
    adult2_li3: "Speaking to a health worker about mental health is a sign of strength, not weakness",
    adult3_title: "Men's Health", adult3_sub: "Common concerns worth regular attention as men age.",
    adult3_li1: "Regular blood pressure and prostate awareness from your 40s",
    adult3_li2: "Don't ignore unexplained weight loss or urinary changes",
    adult3_li3: "Mental health and stress management matter too",
    adult4_title: "Women's Health", adult4_sub: "Key preventive habits beyond pregnancy-specific care.",
    adult4_li1: "Routine screenings matter at every life stage",
    adult4_li2: "Track menstrual and menopausal changes and flag anything unusual",
    adult4_li3: "Bone health and nutrition become more important with age",
    feat10_title: "Adult Health", feat10_body: "General guidance on chronic conditions, mental health, and men's and women's health topics.",
...
function renderFacilities(list, distanceLabel){
  ...
  list.forEach(function(f){
    ...
    const directionsUrl = "https://www.google.com/maps/dir/?api=1&destination=" + f.lat + "," + f.lng + "&destination_place_id=" + encodeURIComponent(f.name);
    card.innerHTML =
      '<div class="fc-name">' + f.name + '</div>' +
      '<div class="fc-meta">' + f.lga + ", " + f.state + dist + '</div>' +
      '<span class="facility-badge">' + f.type + '</span>' +
      '<a href="' + directionsUrl + '" target="_blank" rel="noopener" class="directions-link">📍 ' + (translations[currentLang].findcare_directions || "Get Directions") + '</a>';
...
locateBtn.style.color = "var(--heading)";
locateBtn.style.border = "1px solid var(--line)";
